...
@section('content')
    ...
    <div class="container" style="margin-top: 3%; margin-left: 160px;">
        ...
        {!! Form::open(['action' => ['TicketController@filter'] , 'method' => 'POST']) !!}
        {{csrf_field()}}
        <div class="row">

            {{Form::date('from_date', '' , ['class' => 'form-control' , 'style' => 'width: 200px;' ])}}

            {{Form::date('to_date', '' , ['class' => 'form-control' , 'style' => 'width: 200px; margin-left : 10px;'])}}

            {{Form::text('assin_to', '' , ['class' => 'form-control' ,'id' => 'assignHolder','placeholder' => __('Assigned to:'), 'style' => 'width: 200px; margin-left : 10px;'])}}

            {{Form::text('added_by', '' , ['class' => 'form-control' ,'id' => 'assignHolder','placeholder' => __('Added by:'), 'style' => 'width: 200px; margin-left : 10px;'])}}

            {{Form::submit(__('Filter') , ['class' => 'btn btn-success' , 'style' => "width: 100px;margin-left : 10px;"])}}
