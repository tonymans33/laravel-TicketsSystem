                ...
                <div class="w3-half w3-margin-bottom" style=" border-radius: 25px;width: 700px;">
                    <div class="w3-panel w3-padding-16 w3-white w3-card " style=" border-radius: 25px;">
                        ...
                        <div class="form-group">
                            ...
                            {{Form::date('from_date', $ticket->from_date , ['class' => 'form-control','id' => 'username' ])}}
                        </div>
                        <div class="form-group">
                            {{Form::label('to_date' , __('To:') , ['id' => 'right']) }}
                            {{Form::date('to_date', $ticket->to_date , ['class' => 'form-control','id' => 'username'])}}
                        </div>
                        <div class="form-group">
                            {{Form::label('assin_to' , __('Assigned to:') , ['id' => 'right']) }}
                            {{Form::text('assin_to', $ticket->assin_to , ['class' => 'form-control','id' => 'username'])}}
                        </div>

                        {{Form::submit(__('Update') , ['class' => 'btn btn-outline-warning' , 'style' => "width: 150px"])}}
                        {!! Form::close() !!}
